                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">5000 F</span>
                    </div>
                    <div class="col-auto">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> Ticket</span>
                    <span class="text-nowrap">25.000 F</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5>Ticket</h5>
                      <span class="h2 font-weight-bold mb-0">25.000 F</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Vente</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Hier</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-12">
            <div class="copyright text-center text-xl-left text-muted">copyright
              &copy; 2019 Labelle Group <a href="#" class="font-weight-bold ml-1" target="_blank"></a>
            </div>
          </div>
        </div>
      </footer>
