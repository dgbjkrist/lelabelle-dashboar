...
<head>
  ...
  <title>offres prmotionneles</title>
  <!-- Fontawesome -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.html">Tableau de bord</a>
        <!-- Form -->
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-justify text-muted mb- text-red">Offre1</h5>
                      <span class="h2 font-weight-bold mb-0">10% de reduction sur les tickets pour les fêtes.</span>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-justify text-muted mb-0 text-red">Offre2</h5>
                      <span class="h2 font-weight-bold mb-0">50% de réduction aux 100 premiers à s'enregistrer</span>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-justify text-muted mb-0 text-red">Offre3</h5>
                      <span class="h2 font-weight-bold mb-0">Les cars de Labelle sont climatisés et équipés de wifi.</span>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-justify text-muted mb-0 text-red">Offre4</h5>
                      <span class="h2 font-weight-bold mb-0">Avec Labelle c'est 300 départ/jour d’Abidjan</span>
                    </div>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Offres promotionnelles</h3>
            </div>
            <div class="card-body">
            <div class="row icon-examples">
                <div class="col-lg-12 col-md-12">

                <?php include('./module/offres.php'); ?>
