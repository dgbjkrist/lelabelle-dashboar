...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(../assets/img/theme/profil-cover.jpg); background-size: cover; background-position: center top;">
      <!-- Mask -->
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Bonjour <?php echo "<strong>".$_SESSION['username']."</strong>"; ?></h1>
            <p class="text-white mt-0 mb-5">C'est votre profil.</p>
            <a href="#!" class="btn btn-info">Editer profil</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  Mariette Sow<span class="font-weight-light">, 27</span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>$ote d'ivoire, Abidjan
                </div>
                <div class="h5 mt-4">
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted"> copyright
              &copy; 2019 <a href="#" class="font-weight-bold ml-1" target="_blank">Labelle</a>
            </div>
          </div>
          <div class="col-xl-6">
