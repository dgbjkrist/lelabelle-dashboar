...
<!--
              ...
              <div class="text-center">
                <a href="www.github.com" class="btn btn-neutral btn-icon mr-4">
...
-->
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="../module/registration.php" method="post">
...
<!--
                <div class="text-muted font-italic"><small>Mot de passe : <span class="text-success font-weight-700">Fort</span></small></div>
-->
                <div class="row my-4">
                  <div class="col-12">
...
<!--
                      ...
                      <label class="custom-control-label" for="customCheckRegister">
                        ...
                        <span class="text-muted">Je suis d'accord avec <a href="#!">Privacy Policy</a></span>
          ...
          -->
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary mt-4" name="ajouter">Ajouter</button>
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        ...
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="#" class="nav-link" target="_blank">Labelle Group</a>
            </li>
