...
<head>
  ...
  <title>verification_ticket</title>
   <!-- Fontawesome -->
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Trafic</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Durant le mois passé</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Nouveau utilisateur</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Durant la semaine passée</span>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Offres</h5>
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    ...
                    <span class="text-nowrap">Avant hier yesterday</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Vérification de ticket</h3>
            </div>
            <div class="card-body">
            <div class="row icon-examples">
                <div class="col-lg-12 col-md-12">

                <?php include('../module/ticketverif.php'); ?>
